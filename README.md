# IBM Watson Health Cognitive Services Java SDK Version 1.1.9
...
```gradle
'com.ibm.watson.health.cognitive-services:ibm-whcs-services:1.1.9'
```
...
##### Gradle
```gradle
'com.ibm.watson.health.cognitive-services:annotator-for-clinical-data:1.1.9'
```
