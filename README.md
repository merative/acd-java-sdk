# IBM Watson Health Cognitive Services Java SDK Version 1.5.3
...
## Installation
The current version of this SDK is: 1.5.3
...
```gradle
'com.ibm.watson.health.cognitive-services:ibm-whcs-services:1.5.3'
```
...
##### Gradle
```gradle
'com.ibm.watson.health.cognitive-services:annotator-for-clinical-data:1.5.3'
```
