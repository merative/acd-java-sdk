# IBM Watson Health Cognitive Services Java SDK Version 1.4.1
...
## Installation
The current version of this SDK is: 1.4.1
...
```gradle
'com.ibm.watson.health.cognitive-services:ibm-whcs-services:1.4.1'
```
...
##### Gradle
```gradle
'com.ibm.watson.health.cognitive-services:annotator-for-clinical-data:1.4.1'
```
