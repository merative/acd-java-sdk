...
public class RunPipelineOptionsTest {
  ...
  public void testRunPipelineOptions() throws Throwable {
    ...
    Entity entityModel = new Entity.Builder().build();
    ...
    ContainerAnnotation containerAnnotationModel = new ContainerAnnotation();
    Map<String, Map> metadataMap = new HashMap<String, Map>();
    ...
    assertEquals(unstructuredContainerModel.metadata(), metadataMap);
