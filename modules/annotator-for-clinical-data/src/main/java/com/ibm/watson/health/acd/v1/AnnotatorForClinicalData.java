...
public class AnnotatorForClinicalData extends BaseService {
 ...
 /**
   * Class method which constructs an instance of the `AnnotatorForClinicalData` client.
   * The default service name is used to configure the client instance.
   *
   * @param version The release date of the version of the API you want to use. Specify dates in YYYY-MM-DD format.
   * @return an instance of the `AnnotatorForClinicalData` client using external configuration
   */
  ...
  /**
   * Constructs an instance of the `AnnotatorForClinicalData` client.
   ...
   * @return a {@link ServiceCall} with a void result
   */
  public ServiceCall<String> getAnnotators(GetAnnotatorsOptions getAnnotatorsOptions) {
   ...
   * @return a {@link ServiceCall} with a void result
   */
  public ServiceCall<String> getAnnotators() {
  ...
  public ServiceCall<Annotator> getAnnotatorsById(GetAnnotatorsByIdOptions getAnnotatorsByIdOptions) {
    ...
    builder.query("version", this.version);
    ResponseConverter<Annotator> responseConverter = ResponseConverterUtils.getObject(Annotator.class);
    return createServiceCall(builder.build(), responseConverter);
  }
