...
/**
 * Unit test class for the GetDocumentMultipleCategoriesOptions model.
 */
public class GetDocumentMultipleCategoriesOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetDocumentMultipleCategoriesOptions() throws Throwable {
    ...
    GetDocumentMultipleCategoriesOptions getDocumentMultipleCategoriesOptionsModel = new GetDocumentMultipleCategoriesOptions.Builder()
      ...
      .build();
    assertEquals(getDocumentMultipleCategoriesOptionsModel.corpus(), "testString");
    assertEquals(getDocumentMultipleCategoriesOptionsModel.documentId(), "testString");
    assertEquals(getDocumentMultipleCategoriesOptionsModel.highlightTagBegin(), "testString");
    assertEquals(getDocumentMultipleCategoriesOptionsModel.highlightTagEnd(), "testString");
    assertEquals(getDocumentMultipleCategoriesOptionsModel.fields(), "testString");
    assertEquals(getDocumentMultipleCategoriesOptionsModel.limit(), Long.valueOf("26"));
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetDocumentMultipleCategoriesOptionsError() throws Throwable {
    new GetDocumentMultipleCategoriesOptions.Builder().build();
  }
