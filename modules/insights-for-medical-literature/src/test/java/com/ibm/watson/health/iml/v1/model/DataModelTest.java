...
public class DataModelTest {
  ...
  public void testDataModel() throws Throwable {
    DataModel dataModelModel = new DataModel();
    assertNull(dataModelModel.getConcepts());
    assertNull(dataModelModel.getAttributeValues());
    assertNull(dataModelModel.getRelations());
    assertNull(dataModelModel.getMesh());
    assertNull(dataModelModel.getText());
  }
}