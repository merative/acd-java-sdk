...
/**
 * Unit test class for the UnstructuredModel model.
 */
public class UnstructuredModelTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUnstructuredModel() throws Throwable {
    UnstructuredModel unstructuredModelModel = new UnstructuredModel();
    assertNull(unstructuredModelModel.getText());
    assertNull(unstructuredModelModel.getData());
  }
}