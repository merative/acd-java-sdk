...
public class SearchOptionsTest {
  ...
  public void testSearchOptions() throws Throwable {
    SearchOptions searchOptionsModel = new SearchOptions.Builder()
      ...
      .verbose(true)
      .build();
    assertEquals(searchOptionsModel.corpus(), "testString");
    assertNull(searchOptionsModel.query());
    assertEquals(searchOptionsModel.verbose(), Boolean.valueOf(true));
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testSearchOptionsError() throws Throwable {
