...
/**
 * Unit test class for the MatchEntry model.
 */
public class MatchEntryTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testMatchEntry() throws Throwable {
    MatchEntry matchEntryModel = new MatchEntry();
    assertNull(matchEntryModel.isNegated());
    assertNull(matchEntryModel.getScore());
    assertNull(matchEntryModel.getSentences());
    assertNull(matchEntryModel.getId());
  }
}